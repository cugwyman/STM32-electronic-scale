...
#define Keyboard_Control_Port   GPIOA
#define Keyboard_Line_1 GPIO_Pin_8
#define Keyboard_Line_2 GPIO_Pin_7
#define Keyboard_Line_3 GPIO_Pin_6
#define Keyboard_Line_4 GPIO_Pin_5
#define Keyboard_Row_1 GPIO_Pin_4
#define Keyboard_Row_2 GPIO_Pin_3
#define Keyboard_Row_3 GPIO_Pin_2
#define Keyboard_Row_4 GPIO_Pin_1
...
#define Keyboard_EXTI_PortSource  GPIO_PortSourceGPIOC
#define Keyboard_EXTI_PinSource1  GPIO_PinSource12 
#define Keyboard_EXTI_PinSource2  GPIO_PinSource13 
#define Keyboard_EXTI_PinSource3  GPIO_PinSource14 
#define Keyboard_EXTI_PinSource4  GPIO_PinSource15
